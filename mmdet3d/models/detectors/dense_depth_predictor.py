...
class DenseDepthPredictor(BaseModel, metaclass=ABCMeta):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        losses = self.depth_head.loss(x, batch_data_samples)
        return losses
    ...
    def predict(self, batch_inputs: Tensor,
        ...
        """
        x = self.extract_feat(batch_inputs)
        results_list = self.depth_head.predict(x, batch_data_samples)
    ...
    def _forward(
        ...
        """
        x = self.extract_feat(batch_inputs)
        results = self.depth_head.forward(x)
        return results
        ...
        Returns:
            ...
            contains following keys.
                ...
                - bboxes (Tensor): Has a shape (num_instances, 4),
                    the last dimension 4 arrange as (x1, y1, x2, y2).
        """
        for data_sample, pred_depth_map in zip(data_samples, results_list):
